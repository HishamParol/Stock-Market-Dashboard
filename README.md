...
MA | # of simulations | Profit/Loss | VaR at 95% CF | VaR at 99% CF
--- | --- | ---| --- | ---
...
###### ec2  
2.2145 secs, AWS EC2 is free to try. In free tier it provides 750 hours of Linux and window t2.micro instances each month for one year. There are five ways to pay for Amazon EC2- ON-Demand, Savings Plan, Reserved Instances, Spot instances and Dedicated Hosts
